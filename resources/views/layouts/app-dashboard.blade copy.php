                            ...
                            @if ((auth()->user()->role ?? null) === 'admin')
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-settings">
                                        <div class="dropdown-section-title">System Access</div>

                                        @if (Route::has('settings.users.index'))
                                            <a class="dropdown-item {{ request()->routeIs('settings.users.*') ? 'active' : '' }}"
                                            href="{{ route('settings.users.index') }}">
                                                <i class="bi bi-people-fill me-2"></i>User Management
                                            </a>
                                        @else
                                            <span class="dropdown-item-text text-muted small px-3 py-2">
                                                <i class="bi bi-people-fill me-2"></i>User Management belum tersedia
                                            </span>
                                        @endif
                                    </div>
                                </div>
