...
@section('meta_description', 'Konsultasi program FlexLabs untuk membantu kamu memilih jalur belajar yang sesuai, mulai dari Software Engineering, AI Productivity, UI/UX Design, hingga program praktis.')
...
<section class="relative isolate min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(91,62,142,0.16),transparent_34%),linear-gradient(180deg,#ffffff_0%,#f7f4ff_100%)] pt-28 pb-16 sm:pt-32 lg:pt-36 lg:pb-20">
    ...
    <div class="mx-auto w-full max-w-6xl px-5 sm:px-7 lg:px-10">
        ...
        <div class="mt-10 grid items-start gap-8 lg:grid-cols-12 lg:gap-10">
            <div class="lg:col-span-5">
                <div class="sticky top-28">
                    ...
                    <div class="mt-5 rounded-[1.75rem] border border-flex-primary/10 bg-flex-soft p-5">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <div class="text-sm font-black text-slate-950">Data aman untuk follow up</div>
            ...
            <div class="lg:col-span-7">
                <div class="overflow-hidden rounded-[2rem] border border-flex-primary/10 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
                    <div class="border-b border-slate-200 bg-[radial-gradient(circle_at_top_right,rgba(91,62,142,0.14),transparent_34%),linear-gradient(135deg,#ffffff_0%,#faf8ff_100%)] p-6 sm:p-8">
                        <div class="flex items-start justify-between gap-4">
                            <div class="min-w-0 flex-1">
                                <div class="text-xs font-black uppercase tracking-[0.16em] text-flex-primary">
                                    FlexLabs Consultation
                                </div>

                                <h2 class="mt-2 text-2xl font-black tracking-[-0.04em] text-slate-950 sm:text-3xl">
                                    Isi form konsultasi
                                </h2>

                                <p class="mt-2 text-sm font-semibold leading-6 text-slate-600">
                                    Data ini akan dipakai untuk membantu tim FlexLabs mengarahkan program yang paling sesuai buat kamu.
                                </p>
                            </div>

                            <div class="mt-1 inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-flex-primary/10 text-xl text-flex-primary shadow-[0_14px_34px_rgba(91,62,142,0.10)] sm:h-14 sm:w-14 sm:text-2xl">
                    ...
                    <div class="p-6 sm:p-8">
                        ...
                        <form id="semLeadForm" action="{{ $formAction }}" method="POST">
                            @csrf
                            ...
                            <div class="grid gap-5 md:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        autocomplete="name"
                                        class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-base font-semibold text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-flex-primary focus:ring-4 focus:ring-flex-primary/10 @error('name') border-red-300 focus:border-red-400 focus:ring-red-100 @enderror"
                                        required
                                    >
                                ...
                                <div>
                                    <label for="whatsapp_number" class="mb-2 block text-sm font-black text-slate-800">
                                    ...
                                    <input
                                        ...
                                        autocomplete="tel"
                                        class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-base font-semibold text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-flex-primary focus:ring-4 focus:ring-flex-primary/10 @error('whatsapp_number') border-red-300 focus:border-red-400 focus:ring-red-100 @enderror"
                                        required
                                    >
                                ...
                                <div>
                                    <label for="program_interest" class="mb-2 block text-sm font-black text-slate-800">
                                    ...
                                    @if(!empty($selectedProgram))
                                        ...
                                        <div class="flex min-h-[50px] w-full items-center rounded-2xl border border-flex-primary/15 bg-flex-soft px-4 py-3 text-base font-black text-flex-primary">
                                            {{ $selectedProgram }}
                                        </div>
                                    @else
                                        <select
                                            ...
                                            class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-base font-semibold text-slate-800 outline-none transition focus:border-flex-primary focus:ring-4 focus:ring-flex-primary/10 @error('program_interest') border-red-300 focus:border-red-400 focus:ring-red-100 @enderror"
                                            required
                                        >
                                ...
                                <div>
                                    <label for="best_contact_time" class="mb-2 block text-sm font-black text-slate-800">
                                    ...
                                    <select
                                        ...
                                        class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-base font-semibold text-slate-800 outline-none transition focus:border-flex-primary focus:ring-4 focus:ring-flex-primary/10 @error('best_contact_time') border-red-300 focus:border-red-400 focus:ring-red-100 @enderror"
                                    >
                                ...
                                <div class="md:col-span-2">
                                    <label for="help_need" class="mb-2 block text-sm font-black text-slate-800">
                                    ...
                                    <select
                                        id="help_need"
                                        name="help_need"
                                        class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-base font-semibold text-slate-800 outline-none transition focus:border-flex-primary focus:ring-4 focus:ring-flex-primary/10 @error('help_need') border-red-300 focus:border-red-400 focus:ring-red-100 @enderror"
                                    >
                            ...
                            <button
                                type="submit"
                                id="semLeadSubmitButton"
                                class="mt-5 inline-flex min-h-14 w-full items-center justify-center gap-2 rounded-full bg-flex-primary px-6 py-4 text-center text-sm font-black text-white shadow-[0_18px_38px_rgba(91,62,142,0.28)] transition duration-200 hover:-translate-y-0.5 hover:bg-flex-primaryDark hover:shadow-[0_24px_50px_rgba(91,62,142,0.34)] disabled:cursor-wait disabled:opacity-80 disabled:hover:translate-y-0 disabled:hover:bg-flex-primary"
                            >
                                <span class="sem-submit-spinner hidden h-5 w-5 animate-spin rounded-full border-2 border-white/40 border-t-white"></span>
                                <span class="sem-submit-label">Saya Mau Konsultasi Program</span>
                                <i class="bi bi-arrow-right-short sem-submit-icon shrink-0 text-2xl leading-none"></i>
                            </button>
                        </form>
                    </div>
                </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.getElementById('semLeadForm');
            const submitButton = document.getElementById('semLeadSubmitButton');
            ...
            form.addEventListener('submit', function () {
                const label = submitButton.querySelector('.sem-submit-label');
                const icon = submitButton.querySelector('.sem-submit-icon');
                const spinner = submitButton.querySelector('.sem-submit-spinner');
