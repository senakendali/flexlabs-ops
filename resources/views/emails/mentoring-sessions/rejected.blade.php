...
@section('content')
    <h1 style="margin:0 0 16px; font-size:24px; line-height:1.35; color:#5B3E8E;">
        Mentoring Session Belum Disetujui
    </h1>
    ...
    <p style="margin:0 0 20px; font-size:16px; line-height:1.7;">
        Pengajuan mentoring kamu belum bisa disetujui untuk jadwal ini. Silakan cek detail dan notes di bawah ini.
    </p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0; background:#f9fafb; border:1px solid #ece7f7; border-radius:14px;">
        <tr>
            <td style="padding:20px;">
                ...
                <p style="margin:0 0 8px; font-size:13px; color:#6b7280;">Jadwal yang Diajukan</p>
    ...
    <p style="margin:0; font-size:14px; line-height:1.7; color:#6b7280;">
        Kamu bisa mengajukan jadwal mentoring lain melalui LMS FlexLabs.
    </p>
@endsection