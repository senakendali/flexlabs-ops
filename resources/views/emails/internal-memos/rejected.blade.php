...
@section('content')
    ...
    <h1 style="margin:0 0 16px; font-size:24px; line-height:1.35; color:#5B3E8E;">
        Internal Memo Ditolak
    </h1>

    <p style="margin:0 0 16px; font-size:16px; line-height:1.7;">
        Halo {{ $recipientName ?? 'Team FlexLabs' }},
    </p>

    <p style="margin:0 0 20px; font-size:16px; line-height:1.7;">
        Internal memo yang Anda buat atau submit telah direview dan saat ini berstatus
        <strong>Rejected</strong>. Silakan cek catatan rejection di bawah ini, lalu revisi memo jika diperlukan.
    </p>

    <table width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0; background:#fef2f2; border:1px solid #fecaca; border-radius:14px;">
        <tr>
            <td style="padding:20px;">
                <p style="margin:0 0 8px; font-size:13px; color:#991b1b; font-weight:bold;">
                    Status Memo
                </p>

                <p style="margin:0 0 16px; font-size:22px; font-weight:bold; color:#dc2626;">
                    Rejected
                </p>
