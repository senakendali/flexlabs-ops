...
@section('content')
    ...
    <p style="margin:0 0 20px; font-size:16px; line-height:1.7;">
        Internal memo yang Anda buat atau submit sudah selesai melalui proses approval dan sekarang berstatus
        <strong>Approved</strong>. Silakan cek ringkasan memo di bawah ini.
    </p>

    <table width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0; background:#ecfdf3; border:1px solid #bbf7d0; border-radius:14px;">
        <tr>
            <td style="padding:20px;">
                <p style="margin:0 0 8px; font-size:13px; color:#166534; font-weight:bold;">
                    Status Memo
                </p>

                <p style="margin:0 0 16px; font-size:22px; font-weight:bold; color:#15803d;">
                    Approved
                </p>
