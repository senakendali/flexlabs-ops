...
@php
    ...
    | Section ini berdiri sendiri setelah Sales Performance Overview, bukan di
    | dalam tab Marketing Work Progress.
    */
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="dashboard-section-label mb-3 mt-1">
        <div class="dashboard-section-eyebrow">Meta Ads Overview</div>
        <h4 class="dashboard-section-title mb-1">Meta Ads Campaign Performance</h4>
        <p class="dashboard-section-subtitle mb-0">
            Analisa performa campaign berdasarkan spend, reach, impressions, frequency, engagement, link click, lead form submission, dan WhatsApp chat.
        </p>
    </div>

    {{-- Meta Ads Campaign Performance --}}
    <div class="content-card mb-4 meta-ads-dashboard-card" id="meta-ads-performance">
        <div class="content-card-header d-flex justify-content-between align-items-start gap-3 flex-wrap">
            <div>
        ...
        <div class="content-card-body">
            ...
            @else
                <ul class="nav nav-pills meta-ads-tabs gap-2 flex-nowrap overflow-auto pb-2" id="metaAdsDashboardTabs" role="tablist">
...
<style>
    ...
    .meta-ads-tabs .nav-link.active {
        color: #ffffff;
        background: #5B3E8E;
        border-color: #5B3E8E;
        box-shadow: 0 10px 20px rgba(91, 62, 142, 0.16);
    }
