...
@php
    $typeBadgeClass = function ($type) {
        return match($type ?? 'borrowable') {
            ...
            'fixed' => 'bg-warning-subtle text-warning-emphasis border border-warning-subtle',
                    ...
                    <table class="table table-hover align-middle admin-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-nowrap">Holder / Location</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($equipmentType === 'assigned')
                                            ...
                                            @endif
                                        @elseif ($equipmentType === 'borrowable')
                                        ...
                                        @else
                                            @if ($equipment->location)
                                                <div class="fw-semibold text-dark">{{ $equipment->location }}</div>
                                                <div class="small text-muted">Fixed Location</div>
                                            @else
                    ...
                    <div class="content-card mb-3">
                        <div class="content-card-header">
                            <div>
                                ...
                                <p class="content-card-subtitle mb-0">
                                    Define equipment name, slug, code, asset type, and assigned user when needed.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input
                                        ...
                                        autocomplete="off"
                                    >
                                    <div class="form-text">Enter a unique equipment code.</div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-text" id="typeHelpText">
                                        Can be borrowed temporarily and returned.
                                    </div>
                                ...
                                <div class="col-md-4" id="assignedUserWrapper">
                                    ...
                                    <div class="form-text">Required only when this asset is assigned to a specific user.</div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="location" class="form-label">
                                        Location <span class="text-danger d-none" id="locationRequiredMark">*</span>
                                    </label>
                                    <input type="text" id="location" class="form-control" placeholder="e.g. Office Jakarta / Studio A">
                                    <div class="form-text" id="locationHelpText">
                                        Optional storage or usage location.
                                    </div>
...
<script>
    ...
    function updateAssetTypeFields() {
        ...
        const locationRequiredMark = document.getElementById('locationRequiredMark');
        ...
        fields.location.required = isFixed;
        locationRequiredMark.classList.toggle('d-none', !isFixed);

        if (type === 'assigned') {
            typeHelpText.textContent = 'Assigned to a specific user as a work asset.';
            locationHelpText.textContent = 'Optional current location of the assigned asset.';
        } else if (isFixed) {
            typeHelpText.textContent = 'Placed permanently at a location and cannot be borrowed or assigned.';
            locationHelpText.textContent = 'Required for fixed assets, e.g. Academic Room or Main Office.';
        } else {
            typeHelpText.textContent = 'Can be borrowed temporarily and returned.';
            locationHelpText.textContent = 'Optional storage or usage location.';
        }
    }
    ...
    async function openHistoryModal(id) {
        ...
        try {
            ...
            const data = result.data;
            let html = '';
            const assetType = data.type ?? 'borrowable';
            const assetTypeLabel = {
                assigned: 'Assigned Asset',
                fixed: 'Fixed Asset',
                borrowable: 'Borrowable Asset',
            }[assetType] || 'Borrowable Asset';
                ...
                <div class="content-card mb-3">
                    <div class="content-card-body">
                        ...
                        <small class="text-muted">
                            ${data.code ?? '-'} · ${assetTypeLabel}
                        </small>
                    </div>
                </div>
            `;

            if (assetType === 'borrowable') {
                ...
                html += `
                    <h6 class="mb-3">Fixed Asset Detail</h6>
                    <div class="content-card">
                        <div class="content-card-body">
                            <div class="d-flex align-items-start gap-3">
                                <div class="empty-state-icon flex-shrink-0 mb-0">
                                    <i class="bi bi-geo-alt"></i>
                                </div>
                                <div>
                                    <div class="small text-muted mb-1">Permanent Location</div>
                                    <div class="fw-semibold text-dark">${data.location ?? 'Location Not Set'}</div>
                                    <div class="small text-muted mt-2">
                                        Fixed assets are registered by location and are not available for borrowing or user assignment.
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    fields.type.addEventListener('change', updateAssetTypeFields);
