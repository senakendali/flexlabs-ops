        ...
        <section id="supporting-images" class="scroll-mt-32 border-t border-flex-line px-5 py-10 sm:px-7 lg:px-10">
            <div class="text-center">
                ...
                <h2 class="mt-4 text-3xl font-black leading-tight tracking-[-0.05em] text-flex-dark md:text-5xl">
                    File Pendukung Materi
                </h2>

                <p class="mx-auto mt-4 max-w-3xl text-base font-semibold leading-8 text-flex-muted md:text-lg">
                    Download file pendukung untuk membantu teman-teman mengikuti praktik dengan lebih mudah.
                </p>
            </div>
            ...
            <div class="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                @foreach($galleryImages as $image)
                    @php
                        ...
                        $imageTitle = $normalizeDash($image->caption ?: 'Supporting File ' . $loop->iteration);
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="mt-3 flex items-center gap-3 rounded-[1.15rem] bg-flex-soft px-4 py-3">
                                    ...
                                    <div class="min-w-0">
                                        <p class="truncate text-sm font-black text-flex-dark">
                                            {{ $fileName }}
                                        </p>

                                        <p class="mt-0.5 text-xs font-bold uppercase tracking-[0.12em] text-flex-muted">
                                            File pendukung
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-base font-semibold leading-8 text-flex-muted">
                            Kalau tombol download membuka file di tab baru, klik kanan pada file lalu pilih
                            <strong class="font-black text-flex-dark">Save as</strong>.
                        </p>
                    </div>
