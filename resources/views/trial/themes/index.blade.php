...
<div class="container py-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        <div>
            <h4 class="mb-1">Trial Themes</h4>
            <small class="text-muted">Manage trial themes by program</small>
        </div>
                            ...
                            <td>
                                ...
                                @if ($theme->description)
                                    <small class="text-muted">
                                        {{ \Illuminate\Support\Str::limit($theme->description, 60) }}
                                    </small>
                                @endif
                            </td>
                            <td>{{ $theme->program->name ?? '-' }}</td>
