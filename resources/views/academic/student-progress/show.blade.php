...
@php
    ...
    $overallProgress = max(
        ...
        min(
            100,
            (float) ($studentSummary['overall_progress'] ?? 0)
        )
    );
        ...
        <div class="page-header-content d-flex justify-content-between align-items-start gap-3 flex-wrap">
            <div>
                ...
                <p class="page-subtitle mb-0">
                    Detail progress materi student berdasarkan program, batch,
                    stage, module, topic, dan sub topic yang tersedia.
                </p>
            </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="stat-card h-100">
                ...
                <div
                    class="stat-description text-truncate"
                    title="{{ $student->email ?? '-' }}"
                >
                    {{ $student->email ?? '-' }}
                </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-xl col-md-6">
            <div class="stat-card h-100">
                ...
                <div class="stat-description">
                    Materi pernah dibuka atau sudah diselesaikan.
                </div>
            </div>
        </div>
        ...
        <div class="col-xl col-md-6">
            <div class="stat-card h-100">
                ...
                <div class="stat-description">
                    {{ number_format($videoLessonCount) }} video
                    •
                    {{ number_format($liveSessionCount) }} live
                </div>
            </div>
        </div>
    ...
    <div class="content-card mb-4">
        <div class="content-card-body">
            ...
            <div class="small text-muted mt-2">
                ...
                @else
                    Student terakhir aktif
                    {{ (int) $studentSummary['inactive_days'] }}
                    hari lalu.
                @endif
            </div>
        ...
        <div class="content-card-header">
            <div>
                ...
                <p class="content-card-subtitle mb-0">
                    Video progress mengikuti aktivitas tontonan.
                    Live session yang sudah completed dihitung 100%
                    untuk academic progress.
                </p>
            </div>
            ...
            @if($lessons->count())
                ...
                <div class="student-table-responsive dropdown-safe-table">
                    ...
                    <table class="table table-hover align-middle admin-table student-admin-table mb-0">
                        ...
                        <thead>
                            <tr>
                                <th class="text-nowrap" style="width: 70px;">
                                    No
                                </th>
                        ...
                        <tbody>
                            ...
                            @foreach($lessons as $lesson)
                                ...
                                @php
                                     ...
                                     * Raw VOD progress.
                                     *
                                     * Nilai ini tetap dipertahankan supaya
                                     * data tontonan sebenarnya tidak berubah.
                                     */
                                    $rawProgressValue = max(
                                        0,
                                        min(
                                            100,
                                            (float) (
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($isLiveSession)
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <span
                                                    class="badge rounded-pill {{ $isCompleted
                                                        ? 'bg-success-subtle text-success-emphasis border border-success-subtle'
                                                        : 'bg-warning-subtle text-warning-emphasis border border-warning-subtle'
                                                    }}"
                                                >
                                    ...
                                    <td>
                                        ...
                                        @if($isLiveSession && $isCompleted && $rawProgressValue > 0)

                                            <div class="small text-muted mt-1">
                                                Video watched:
                                                {{ rtrim(rtrim(number_format($rawProgressValue, 2), '0'), '.') }}%
                                            </div>
                                    ...
                                    <td>
                                        ...
                                        @if(
                                            ...
                                            <div class="small text-muted">
                                                Waiting for live session completion
                                            </div>

                                        @else

                                            @if(!empty($lesson->last_watched_at))
            ...
            @else
                ...
                <div class="text-center py-5 px-3">
                    ...
                    <p class="text-muted mb-4">
                        Student ini belum memiliki materi aktif dari program,
                        batch, atau stage yang dipilih.
                    </p>
