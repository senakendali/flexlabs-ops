    ...
    private function definitions(): array
    {
        return [
            ...
            [
                ...
                'description' => 'Persentase student aktif yang progress aktualnya mencapai minimal 90% dari expected progress timeline batch masing-masing.',
                'division' => 'academic',
                'category' => 'learning',
                'unit' => KpiDefinition::UNIT_PERCENTAGE,
                'direction' => KpiDefinition::DIRECTION_HIGHER,
                ...
                'calculation_settings' => [
                    'value_type' => 'ratio',
                    'numerator_key' => 'on_track_active_students',
                    'denominator_key' => 'eligible_active_students',
                    'eligibility_basis' => 'active_batch_timeline',
                    'schedule_achievement_threshold_percentage' => 90,
                    'multiplier' => 100,
                    'precision' => 2,
                ],
                'sort_order' => 90,
