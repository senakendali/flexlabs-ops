...
class MentoringSessionApprovedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Mentoring Session Disetujui')
            ->view('emails.mentoring-sessions.approved', [
                ...
                'meetingUrl' => $this->session->meeting_url,
