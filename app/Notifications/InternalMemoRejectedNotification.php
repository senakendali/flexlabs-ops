...
class InternalMemoRejectedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Internal Memo Rejected: ' . ($this->memo->memo_number ?? 'Internal Memo FlexLabs'))
            ->view('emails.internal-memos.rejected', [
                'title' => 'Internal Memo Ditolak',
                ...
                'rejectedBy' => $this->approval?->approver?->name
                    ?? $this->approval?->approver_name
                    ?? 'Approver FlexLabs',

                'rejectedAt' => $this->formatDateTime(
                    $this->approval?->rejected_at ?? $this->memo->rejected_at
                ),

                'rejectionNotes' => $this->approval?->notes,
